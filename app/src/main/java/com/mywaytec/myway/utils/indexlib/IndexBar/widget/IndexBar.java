package com.mywaytec.myway.utils.indexlib.IndexBar.widget;
...
import com.mywaytec.myway.utils.indexlib.IndexBar.helper.IIndexBarDataHelper;
import com.mywaytec.myway.utils.indexlib.IndexBar.helper.IndexBarDataHelperImpl;
...
public class IndexBar extends View {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mPressedBackground = Color.WHITE;//默认按下是纯黑色
