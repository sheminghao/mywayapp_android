...
import com.mywaytec.myway.ui.im.conversation.ConversationView;
...
public class CreateClubPresenter extends RxPresenter<CreateClubView> {
    ...
    @Inject
    public CreateClubPresenter(RetrofitHelper retrofitHelper) {
    ...
    @Override
    public void attachView(CreateClubView view) {
     ...
     * @param city 城市
     */
    public void createClub(String name, String description, String country, String province, String city){
        ...
        retrofitHelper.createRongClub(bodyMap)
