...
/**
 */
public class GridOnlyImageAdapter extends
        RecyclerView.Adapter<GridOnlyImageAdapter.ViewHolder> implements View.OnClickListener, PopupWindow.OnDismissListener {
    ...
    public GridOnlyImageAdapter(Context context, onAddPicClickListener mOnAddPicClickListener) {
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            viewHolder.mImg.setImageResource(R.mipmap.dongtai_fabiao_tianjiazhaopian);
...
//                    }else {
//                        InputMethodUtils.closeSoftKeyboard((Activity)mContext);
//                        openPopupWindow(v);
//                    }
                }
            });
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.tv_pick_phone:
                //选择图片
                mOnAddPicClickListener.onAddPicClick(0, -1);
                popupWindow.dismiss();
                break;
            case R.id.tv_pick_zone:
                //选择视频
                mOnAddPicClickListener.onAddPicClick(0, -2);
                popupWindow.dismiss();
                break;
            case R.id.tv_cancel:
                popupWindow.dismiss();
